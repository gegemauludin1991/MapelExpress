...
// =====================================================================
// A. SATPAM SISTEM KETAT (ANTI-BYPASS URL BELAKANG)
// =====================================================================
async function proteksiHalaman() {
    try {
        ...
        // Kalo belum login tapi maksa akses halaman dalam, tendang paksa ke login page!
        if (!session) {
            if (!isAuthPage) {
        ...
        // Kalo sudah login, tarik role aslinya dari tabel profiles database
        if (session) {
            ...
            // VALIDASI ROLE: Jika role tidak sesuai dengan halaman, lariin ke halaman hak aksesnya!
...
// =====================================================================
// B. MOCK SOCKET.IO INTERFACES (Penyambung Logic Lama)
// =====================================================================
window.socketBridge = {
    events: {},
