...
class DynamicMap {
    ...
    drawRoute(waypointsArray, callbackSummary) {
        ...
        this.routingControl = L.Routing.control({
            ...
            // FIX FATAL: URL dikembalikan murni ke /route/v1 (Tanpa /driving di akhir)
            // Biar Leaflet Routing Machine yang otomatis nambahin profile-nya.
        ...
        // Tambahan pendeteksi error, kalo server down lu bakal dapet notif
